<%@ page import="Listeners.OnlineUserCounter" %>
...
<head>
    ...
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="<%=basePath%>/asset/vendor/font-awesome/css/font-awesome.min.css">
    <!-- Custom Font Icons CSS-->
    <link rel="stylesheet" href="<%=basePath%>/asset/css/font.css">
    <!-- Google fonts - Muli-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Muli:300,400,700">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="<%=basePath%>/asset/css/style.default.css" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="<%=basePath%>/asset/css/custom.css">
    <!-- Favicon-->
    <link rel="shortcut icon" href="<%=basePath%>/asset/img/favicon.ico">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="search-panel">
                <div class="search-inner d-flex align-items-center justify-content-center">
                    ...
                    <form id="search" method="post" action="${pageContext.request.contextPath}/SearchServlet" onkeyup="check();">
            ...
            </div>        <div class="container-fluid d-flex align-items-center justify-content-between">
            <div class="navbar-header">
                <!-- Navbar Header--><a href="index.html" class="navbar-brand">
                <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">VERTEX</strong><strong>BOUTIQUE</strong></div>
                <div class="brand-text brand-sm"><strong class="text-primary">V</strong><strong>B</strong></div></a>
                <!-- Sidebar Toggle Btn-->
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item logout">
                    <a id="logout" href="${pageContext.request.contextPath}/LogoutServlet" class="nav-link">Logout <i class="icon-logout"></i></a></div>
            </div>
        </div>
    </nav>
</header>
<div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center">
            ...
            <div class="title">
                <h1 class="h5">Medy MISSANG</h1>
                <p>Web Designer</p>
            </div>
        </div>
        <!-- Sidebar Navidation Menus--><span class="heading">Main</span>
        <ul class="list-unstyled">
            <li class="active"><a a href="${pageContext.request.contextPath}/Admin/Admin.jsp"></i>Home </a></li>
            <li><a href="${pageContext.request.contextPath}/UserListServlet"> <i class="icon-grid"></i>List </a></li>
            <li><a href="${pageContext.request.contextPath}/Admin/AddUser.jsp"> <i class="icon-padnote"></i> Add </a></li>
            <li><a href="${pageContext.request.contextPath}/UserLogServlet"> <i class="fa fa-bar-chart "></i>Forms </a></li>
            <li><a href="#" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Example dropdown </a>
            </li>
            <li><a href="${pageContext.request.contextPath}/Login.jsp">Log in <i class="icon-logout"></i></a></li>
